...
#[Title('Create Global Property Type')]
class extends Component {
    ...
    public function save()
    {
        ...
        PropertyType::create([
            'name' => trim($this->name),
            'tenant_id' => null, // Super Admin always creates global types
        ]);

        session()->flash('success', 'Global property type created successfully.');
