...
<div class="p-4 sm:p-6 lg:p-10 max-w-5xl mx-auto text-gray-900 dark:text-white space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
            <h1 class="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white">Edit Role: {{ ucwords($role->name) }}</h1>
            <p class="text-gray-500 dark:text-slate-400 mt-1">Modify the role name and adjust its system permissions.</p>
        </div>
    ...
    <form wire:submit="update" class="space-y-6">
        ...
        <div class="bg-white dark:bg-[#0b0f19] rounded-xl border border-gray-200 dark:border-slate-700/50 shadow-sm p-5 sm:p-6">
            ...
            <p class="text-xs text-gray-400 dark:text-slate-500 mt-2">Warning: Changing this name will affect all users currently assigned to this role across all tenants.</p>
        </div>
