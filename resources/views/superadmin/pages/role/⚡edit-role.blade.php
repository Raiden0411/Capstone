...
<div class="max-w-5xl mx-auto py-8 px-4 sm:px-6 lg:px-8 space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
            ...
            <p class="text-gray-500 dark:text-white/50 mt-1">Modify the role name and adjust its system permissions.</p>
        </div>
    ...
    <form wire:submit="update" class="space-y-6">
        ...
        <div class="bg-white dark:bg-white/5 dark:backdrop-blur-md border border-gray-200 dark:border-white/10 rounded-2xl p-5 sm:p-6 shadow-sm dark:shadow-none">
            ...
            <p class="text-xs text-gray-400 dark:text-white/40 mt-2">Warning: Changing this name will affect all users currently assigned to this role across all tenants.</p>
        </div>
