...
<div class="p-4 sm:p-6 lg:p-8 max-w-3xl mx-auto space-y-6">
    ...
    {{-- Form --}}
    <form wire:submit="save" class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl p-6 shadow-sm space-y-6">
        ...
        <div>
            ...
            @if ($image)
                <div class="mt-3">
                    <img src="{{ $image->temporaryUrl() }}" class="h-32 w-32 object-cover rounded-lg border border-gray-200 dark:border-gray-700" alt="Event Preview">
                    <button type="button" wire:click="$set('image', null)" class="mt-2 text-xs text-red-500 dark:text-red-400 hover:text-red-700">Remove photo</button>
                </div>
            @endif
        </div>
