...
<div class="p-4 sm:p-6 lg:p-10 max-w-3xl mx-auto space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl sm:text-3xl font-bold text-white">Edit Property Type</h1>
            <p class="text-white/60 mt-1">Update the name of your custom type.</p>
        </div>
    ...
    <form wire:submit="update" class="space-y-5 glass-card !rounded-xl p-5 sm:p-6">
        <div>
            ...
            <p class="text-xs text-white/40 mt-1">Changing the name will not affect existing properties.</p>
        </div>
