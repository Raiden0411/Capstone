{{-- resources/views/tenant/pages/role/⚡create-role.blade.php --}}
<?php
...
<div class="p-4 sm:p-6 lg:p-8 max-w-3xl mx-auto space-y-6">
    ...
    <div class="flex items-center justify-between pb-6 border-b border-gray-200 dark:border-gray-700">
        <h1 class="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white">Create Custom Role</h1>
    ...
    <form wire:submit="save" class="space-y-6 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl p-5 sm:p-6 shadow-sm">
