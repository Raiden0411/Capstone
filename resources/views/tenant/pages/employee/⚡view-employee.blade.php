    ...
    <div class="flex flex-col md:flex-row gap-4 items-start md:items-center">
        ...
        <div class="flex flex-wrap gap-2 w-full md:w-auto">
            <select wire:model.live="roleFilter"
                    class="bg-white dark:bg-gray-900 border border-gray-300 dark:border-gray-600 rounded-xl py-3 px-4 text-sm text-gray-900 dark:text-white focus:ring-2 focus:ring-[#376df1]/50 focus:border-[#376df1] transition appearance-none">
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                            <td class="px-4 sm:px-6 py-4">
                                <div class="flex items-center gap-3">
                                    <div class="h-10 w-10 rounded-lg bg-blue-50 dark:bg-blue-500/10 flex items-center justify-center text-[#376df1] dark:text-blue-300 font-semibold text-sm shrink-0 overflow-hidden">
                                        @if($employee->avatar)
                                    ...
                                    <div>
                                        <div class="flex items-center gap-2">
                                            ...
                                            @if(strtolower($employee->role ?? '') === 'manager')
                                                <span class="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-[10px] font-bold bg-blue-100 dark:bg-blue-500/15 text-blue-700 dark:text-blue-300 border border-blue-200 dark:border-blue-500/30">
