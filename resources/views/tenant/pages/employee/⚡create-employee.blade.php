...
class extends Component {
    ...
    public function getAvailableRolesProperty()
    {
        ...
        // Apply role search and type filter
        return $roles
    ...
    {
        // Only auto-select when creating a new user and no roles selected yet
...
<div class="p-4 sm:p-6 lg:p-8 max-w-3xl mx-auto space-y-6">
    ...
    <div class="flex items-center justify-between pb-6 border-b border-gray-200 dark:border-gray-700">
        ...
        <a href="{{ route('tenant.employees.index') }}" wire:navigate class="text-sm font-medium text-gray-500 dark:text-gray-400 hover:text-[#376df1] dark:hover:text-blue-400 transition-colors">
            &larr; Back to Employees
        </a>
    </div>

    <form wire:submit="save" class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl p-5 sm:p-6 shadow-sm space-y-5">
        ...
        <div class="flex gap-3">
            ...
            <button type="button" wire:click="generateCode"
                    class="self-end px-4 py-3 rounded-full border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700 transition text-sm">
                Generate
            </button>
        </div>
        ...
        <div class="border-t border-gray-200 dark:border-gray-700 pt-5">
            ...
            <div class="grid grid-cols-3 gap-2">
                @foreach([
                    ...
                    <label class="cursor-pointer">
                        ...
                        <div class="border-2 border-gray-200 dark:border-gray-700 rounded-xl p-3 text-center transition cursor-pointer
                                    {{ $user_mode === $val ? 'border-[#376df1] bg-blue-50 dark:bg-blue-500/10' : 'hover:border-gray-300 dark:hover:border-gray-600' }}">
            ...
            @if($user_mode === 'existing')
                <div class="mt-4">
                    ...
                    <input type="text" wire:model.live="search" placeholder="Type name, email or phone…"
                           class="w-full bg-white dark:bg-gray-900 border border-gray-300 dark:border-gray-600 rounded-xl py-3 px-4 text-sm text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-[#376df1]/50 focus:border-[#376df1] transition">
            ...
            @if($user_mode === 'new')
                <div class="grid grid-cols-1 gap-4 mt-4 pl-4 border-l-2 border-[#376df1]">
                    <div>
                    ...
                    {{-- Role selection with search, filter, quick create --}}
                    <div>
