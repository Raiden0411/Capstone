                    ...
                    <ul class="flex flex-col space-y-1"
                        ...
                        <li>
                            <a href="{{ route('superadmin.dashboard') }}" wire:navigate
                               ...
                               class="group flex items-center gap-x-3.5 rounded-lg px-3 py-2.5 text-sm transition-colors focus-visible:ring-2 focus-visible:ring-primary-500/50
                                      {{ request()->routeIs('superadmin.dashboard') ? 'bg-primary-50 text-primary-700 dark:bg-primary-500/20 dark:text-primary-300' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900 dark:text-gray-300 dark:hover:bg-gray-800 dark:hover:text-white' }}">
                        ...
                        <li>
                            <a href="{{ route('superadmin.analytics') }}" wire:navigate
                               ...
                               title="Analytics"
                               class="group flex items-center gap-x-3.5 rounded-lg px-3 py-2.5 text-sm transition-colors focus-visible:ring-2 focus-visible:ring-primary-500/50
                                      {{ request()->routeIs('superadmin.analytics') ? 'bg-primary-50 text-primary-700 dark:bg-primary-500/20 dark:text-primary-300' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900 dark:text-gray-300 dark:hover:bg-gray-800 dark:hover:text-white' }}">
                        ...
                        <li>
                            <a href="{{ route('superadmin.tenants.index') }}" wire:navigate
                               ...
                               title="Tenants"
                               class="group flex items-center gap-x-3.5 rounded-lg px-3 py-2.5 text-sm transition-colors focus-visible:ring-2 focus-visible:ring-primary-500/50
                                      {{ request()->routeIs('superadmin.tenants.*') ? 'bg-primary-50 text-primary-700 dark:bg-primary-500/20 dark:text-primary-300' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900 dark:text-gray-300 dark:hover:bg-gray-800 dark:hover:text-white' }}">
                        ...
                        <li>
                            <a href="{{ route('superadmin.tenant-types.index') }}" wire:navigate
                               ...
                               title="Tenant Types"
                               class="group flex items-center gap-x-3.5 rounded-lg px-3 py-2.5 text-sm transition-colors focus-visible:ring-2 focus-visible:ring-primary-500/50
                                      {{ request()->routeIs('superadmin.tenant-types.*') ? 'bg-primary-50 text-primary-700 dark:bg-primary-500/20 dark:text-primary-300' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900 dark:text-gray-300 dark:hover:bg-gray-800 dark:hover:text-white' }}">
                        ...
                        <li>
                            <a href="{{ route('superadmin.users.index') }}" wire:navigate
                               ...
                               title="Users"
                               class="group flex items-center gap-x-3.5 rounded-lg px-3 py-2.5 text-sm transition-colors focus-visible:ring-2 focus-visible:ring-primary-500/50
                                      {{ request()->routeIs('superadmin.users.*') ? 'bg-primary-50 text-primary-700 dark:bg-primary-500/20 dark:text-primary-300' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900 dark:text-gray-300 dark:hover:bg-gray-800 dark:hover:text-white' }}">
                        ...
                        <li>
                            <a href="{{ route('superadmin.roles.index') }}" wire:navigate
                               ...
                               title="Roles"
                               class="group flex items-center gap-x-3.5 rounded-lg px-3 py-2.5 text-sm transition-colors focus-visible:ring-2 focus-visible:ring-primary-500/50
                                      {{ request()->routeIs('superadmin.roles.*') ? 'bg-primary-50 text-primary-700 dark:bg-primary-500/20 dark:text-primary-300' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900 dark:text-gray-300 dark:hover:bg-gray-800 dark:hover:text-white' }}">
                        ...
                        <li>
                            <a href="{{ route('superadmin.events.index') }}" wire:navigate
                               ...
                               title="Events"
                               class="group flex items-center gap-x-3.5 rounded-lg px-3 py-2.5 text-sm transition-colors focus-visible:ring-2 focus-visible:ring-primary-500/50
                                      {{ request()->routeIs('superadmin.events.*') ? 'bg-primary-50 text-primary-700 dark:bg-primary-500/20 dark:text-primary-300' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900 dark:text-gray-300 dark:hover:bg-gray-800 dark:hover:text-white' }}">
                        ...
                        <li>
                            <a href="{{ route('superadmin.homepage.editor') }}" wire:navigate
                               ...
                               class="group flex items-center gap-x-3.5 rounded-lg px-3 py-2.5 text-sm transition-colors focus-visible:ring-2 focus-visible:ring-primary-500/50
                                      {{ request()->routeIs('superadmin.homepage.editor') ? 'bg-primary-50 text-primary-700 dark:bg-primary-500/20 dark:text-primary-300' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900 dark:text-gray-300 dark:hover:bg-gray-800 dark:hover:text-white' }}">
                        ...
                        <li>
                            <a href="{{ route('superadmin.about.editor') }}" wire:navigate
                               ...
                               class="group flex items-center gap-x-3.5 rounded-lg px-3 py-2.5 text-sm transition-colors focus-visible:ring-2 focus-visible:ring-primary-500/50
                                      {{ request()->routeIs('superadmin.about.editor') ? 'bg-primary-50 text-primary-700 dark:bg-primary-500/20 dark:text-primary-300' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900 dark:text-gray-300 dark:hover:bg-gray-800 dark:hover:text-white' }}">
                                <svg class="size-4 shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 20h9"/><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"/></svg>
                        ...
                        <li>
                            <a href="{{ route('superadmin.map-markers.index') }}" wire:navigate
                               ...
                               title="Map Markers"
                               class="group flex items-center gap-x-3.5 rounded-lg px-3 py-2.5 text-sm transition-colors focus-visible:ring-2 focus-visible:ring-primary-500/50
                                      {{ request()->routeIs('superadmin.map-markers.*') ? 'bg-primary-50 text-primary-700 dark:bg-primary-500/20 dark:text-primary-300' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900 dark:text-gray-300 dark:hover:bg-gray-800 dark:hover:text-white' }}">
