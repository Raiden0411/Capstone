...
<div>
    ...
    >
        <div class="relative flex h-full max-h-full flex-col">
            ...
            {{-- Header (aligned height with top header line) --}}
            <div class="flex h-[56.8px] shrink-0 items-center justify-between border-b border-gray-200 px-4 dark:border-gray-700"
                 :class="minified ? 'lg:justify-center lg:px-2' : ''">
                <div class="flex items-center gap-2 overflow-hidden">
                    <a href="{{ route('superadmin.dashboard') }}"
                       class="flex items-center gap-2 font-display text-xl font-bold tracking-tight whitespace-nowrap text-gray-900 dark:text-white focus-visible:ring-2 focus-visible:ring-primary-500/50 rounded transition-all duration-200 hover:opacity-80 active:scale-[0.98]">
                        @if($logoUrl)
                        ...
                        @endif
                        <span x-show="!minified" x-cloak>{{ $siteName }}</span>
                    </a>
                </div>

                {{-- Mobile Close --}}
                <button type="button"
                        class="flex size-8 items-center justify-center rounded-full bg-gray-100 text-gray-500 transition-all duration-200 hover:bg-gray-200 hover:text-gray-800 active:scale-95 lg:hidden dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white focus-visible:ring-2 focus-visible:ring-primary-500/50"
                        @click="mobileOpen = false"
                    ...
                    <ul class="flex flex-col space-y-1"
                        ...
                        <li>
                            <a href="{{ route('superadmin.dashboard') }}"
                               ...
                               title="Dashboard"
                               class="group relative flex items-center gap-x-3.5 rounded-lg px-3 py-2.5 text-sm transition-all duration-200 active:scale-[0.98] focus-visible:ring-2 focus-visible:ring-primary-500/50
                                      {{ request()->routeIs('superadmin.dashboard') ? 'bg-primary-50 text-primary-700 dark:bg-primary-500/20 dark:text-primary-300 border-l-2 border-l-primary-600' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900 dark:text-gray-300 dark:hover:bg-gray-800 dark:hover:text-white border-l-2 border-l-transparent' }}">
                        ...
                        <li>
                            <a href="{{ route('superadmin.analytics') }}"
                               ...
                               title="Analytics"
                               class="group relative flex items-center gap-x-3.5 rounded-lg px-3 py-2.5 text-sm transition-all duration-200 active:scale-[0.98] focus-visible:ring-2 focus-visible:ring-primary-500/50
                                      {{ request()->routeIs('superadmin.analytics') ? 'bg-primary-50 text-primary-700 dark:bg-primary-500/20 dark:text-primary-300 border-l-2 border-l-primary-600' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900 dark:text-gray-300 dark:hover:bg-gray-800 dark:hover:text-white border-l-2 border-l-transparent' }}">
                        ...
                        <li>
                            <a href="{{ route('superadmin.tenants.index') }}"
                               ...
                               title="Tenants"
                               class="group relative flex items-center gap-x-3.5 rounded-lg px-3 py-2.5 text-sm transition-all duration-200 active:scale-[0.98] focus-visible:ring-2 focus-visible:ring-primary-500/50
                                      {{ request()->routeIs('superadmin.tenants.*') ? 'bg-primary-50 text-primary-700 dark:bg-primary-500/20 dark:text-primary-300 border-l-2 border-l-primary-600' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900 dark:text-gray-300 dark:hover:bg-gray-800 dark:hover:text-white border-l-2 border-l-transparent' }}">
                        ...
                        <li>
                            <a href="{{ route('superadmin.users.index') }}"
                               ...
                               title="Users"
                               class="group relative flex items-center gap-x-3.5 rounded-lg px-3 py-2.5 text-sm transition-all duration-200 active:scale-[0.98] focus-visible:ring-2 focus-visible:ring-primary-500/50
                                      {{ request()->routeIs('superadmin.users.*') ? 'bg-primary-50 text-primary-700 dark:bg-primary-500/20 dark:text-primary-300 border-l-2 border-l-primary-600' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900 dark:text-gray-300 dark:hover:bg-gray-800 dark:hover:text-white border-l-2 border-l-transparent' }}">
                        ...
                        {{-- Tenant Types --}}
                        <li>
                            <a href="{{ route('superadmin.tenant-types.index') }}"
                               aria-current="{{ request()->routeIs('superadmin.tenant-types.*') ? 'page' : 'false' }}"
                               title="Tenant Types"
                               class="group relative flex items-center gap-x-3.5 rounded-lg px-3 py-2.5 text-sm transition-all duration-200 active:scale-[0.98] focus-visible:ring-2 focus-visible:ring-primary-500/50
                                      {{ request()->routeIs('superadmin.tenant-types.*') ? 'bg-primary-50 text-primary-700 dark:bg-primary-500/20 dark:text-primary-300 border-l-2 border-l-primary-600' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900 dark:text-gray-300 dark:hover:bg-gray-800 dark:hover:text-white border-l-2 border-l-transparent' }}">
                        ...
                        <li>
                            <a href="{{ route('superadmin.roles.index') }}"
                               ...
                               title="Roles"
                               class="group relative flex items-center gap-x-3.5 rounded-lg px-3 py-2.5 text-sm transition-all duration-200 active:scale-[0.98] focus-visible:ring-2 focus-visible:ring-primary-500/50
                                      {{ request()->routeIs('superadmin.roles.*') ? 'bg-primary-50 text-primary-700 dark:bg-primary-500/20 dark:text-primary-300 border-l-2 border-l-primary-600' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900 dark:text-gray-300 dark:hover:bg-gray-800 dark:hover:text-white border-l-2 border-l-transparent' }}">
                        ...
                        <li>
                            <a href="{{ route('superadmin.events.index') }}"
                               ...
                               title="Events"
                               class="group relative flex items-center gap-x-3.5 rounded-lg px-3 py-2.5 text-sm transition-all duration-200 active:scale-[0.98] focus-visible:ring-2 focus-visible:ring-primary-500/50
                                      {{ request()->routeIs('superadmin.events.*') ? 'bg-primary-50 text-primary-700 dark:bg-primary-500/20 dark:text-primary-300 border-l-2 border-l-primary-600' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900 dark:text-gray-300 dark:hover:bg-gray-800 dark:hover:text-white border-l-2 border-l-transparent' }}">
                        ...
                        {{-- Homepage Editor --}}
                        <li>
                            <a href="{{ route('superadmin.homepage.editor') }}"
                               aria-current="{{ request()->routeIs('superadmin.homepage.editor') ? 'page' : 'false' }}"
                               title="Homepage Editor"
                               class="group relative flex items-center gap-x-3.5 rounded-lg px-3 py-2.5 text-sm transition-all duration-200 active:scale-[0.98] focus-visible:ring-2 focus-visible:ring-primary-500/50
                                      {{ request()->routeIs('superadmin.homepage.editor') ? 'bg-primary-50 text-primary-700 dark:bg-primary-500/20 dark:text-primary-300 border-l-2 border-l-primary-600' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900 dark:text-gray-300 dark:hover:bg-gray-800 dark:hover:text-white border-l-2 border-l-transparent' }}">
                        ...
                        {{-- About Page Editor --}}
                        <li>
                            <a href="{{ route('superadmin.about.editor') }}"
                               aria-current="{{ request()->routeIs('superadmin.about.editor') ? 'page' : 'false' }}"
                               title="About Page Editor"
                               class="group relative flex items-center gap-x-3.5 rounded-lg px-3 py-2.5 text-sm transition-all duration-200 active:scale-[0.98] focus-visible:ring-2 focus-visible:ring-primary-500/50
                                      {{ request()->routeIs('superadmin.about.editor') ? 'bg-primary-50 text-primary-700 dark:bg-primary-500/20 dark:text-primary-300 border-l-2 border-l-primary-600' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900 dark:text-gray-300 dark:hover:bg-gray-800 dark:hover:text-white border-l-2 border-l-transparent' }}">
                                <svg class="size-4 shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 20h9"/><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"/></svg>
                        ...
                        {{-- Map Markers --}}
                        <li>
                            <a href="{{ route('superadmin.map-markers.index') }}"
                               aria-current="{{ request()->routeIs('superadmin.map-markers.*') ? 'page' : 'false' }}"
                               title="Map Markers"
                               class="group relative flex items-center gap-x-3.5 rounded-lg px-3 py-2.5 text-sm transition-all duration-200 active:scale-[0.98] focus-visible:ring-2 focus-visible:ring-primary-500/50
                                      {{ request()->routeIs('superadmin.map-markers.*') ? 'bg-primary-50 text-primary-700 dark:bg-primary-500/20 dark:text-primary-300 border-l-2 border-l-primary-600' : 'text-gray-600 hover:bg-gray-100 hover:text-gray-900 dark:text-gray-300 dark:hover:bg-gray-800 dark:hover:text-white border-l-2 border-l-transparent' }}">
