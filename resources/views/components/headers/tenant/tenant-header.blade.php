...
>
  <nav class="px-4 sm:px-6 flex basis-full items-center w-full mx-auto justify-between gap-2">
    ...
    <div class="flex items-center gap-2 ms-auto">
      ...
      {{-- View Public Site --}}
      @if($tenant)
        <a href="{{ route('tenant.show', $tenant->slug) }}" target="_blank" rel="noopener"
      ...
      @else
        <a href="{{ route('login') }}" class="py-2 px-4 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg bg-[#376df1] text-white hover:bg-blue-700 transition-colors">Sign in</a>
      @endauth
    </div>
  </nav>
</header>