    ...
    <div class="relative flex flex-col h-full max-h-full">
        ...
        <div class="py-2.5 px-4 flex justify-between items-center gap-x-2">
            <div class="-ms-2 flex items-center gap-x-1" x-show="!minified">
                <a class="flex items-center gap-2 font-bold text-xl text-gray-900 dark:text-white" href="{{ route('tenant.dashboard') }}" wire:navigate aria-label="Tenant Dashboard">
                    ...
                    <span>{{ auth()->user()->tenant->name ?? 'Business' }}</span>
                </a>
            </div>
