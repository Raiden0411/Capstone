                ...
                <ul class="flex flex-col space-y-1">
                    ...
                    <li>
                        <a href="{{ $dashboardRoute }}" wire:navigate
                           class="group flex items-center gap-x-3.5 py-2.5 px-3 text-sm rounded-lg transition-colors
                                  {{ request()->routeIs('tenant.dashboard') || request()->routeIs('tenant.employee.dashboard') ? 'bg-blue-50 dark:bg-blue-500/20 text-blue-700 dark:text-blue-300' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 hover:text-gray-900 dark:hover:text-white' }}">
                    ...
                    <li>
                        <a href="{{ route('tenant.analytics.index') }}" wire:navigate
                           class="group flex items-center gap-x-3.5 py-2.5 px-3 text-sm rounded-lg transition-colors
                                  {{ request()->routeIs('tenant.analytics.*') ? 'bg-blue-50 dark:bg-blue-500/20 text-blue-700 dark:text-blue-300' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 hover:text-gray-900 dark:hover:text-white' }}">
                    ...
                    <li>
                        <a href="{{ route('tenant.bookings.index') }}" wire:navigate
                           class="group flex items-center gap-x-3.5 py-2.5 px-3 text-sm rounded-lg transition-colors
                                  {{ request()->routeIs('tenant.bookings.*') && !request()->routeIs('tenant.bookings.history') ? 'bg-blue-50 dark:bg-blue-500/20 text-blue-700 dark:text-blue-300' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 hover:text-gray-900 dark:hover:text-white' }}">
                    ...
                    <li>
                        <a href="{{ route('tenant.bookings.history') }}" wire:navigate
                           class="group flex items-center gap-x-3.5 py-2.5 px-3 text-sm rounded-lg transition-colors
                                  {{ request()->routeIs('tenant.bookings.history') ? 'bg-blue-50 dark:bg-blue-500/20 text-blue-700 dark:text-blue-300' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 hover:text-gray-900 dark:hover:text-white' }}">
                    ...
                    <li>
                        <a href="{{ route('tenant.settings.overview') }}" wire:navigate
                           class="group flex items-center gap-x-3.5 py-2.5 px-3 text-sm rounded-lg transition-colors
                                  {{ request()->routeIs('tenant.settings.overview') ? 'bg-blue-50 dark:bg-blue-500/20 text-blue-700 dark:text-blue-300' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 hover:text-gray-900 dark:hover:text-white' }}">
                    ...
                    <li>
                        <a href="{{ route('tenant.events.index') }}" wire:navigate
                           class="group flex items-center gap-x-3.5 py-2.5 px-3 text-sm rounded-lg transition-colors
                                  {{ request()->routeIs('tenant.events.*') ? 'bg-blue-50 dark:bg-blue-500/20 text-blue-700 dark:text-blue-300' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 hover:text-gray-900 dark:hover:text-white' }}">
                    ...
                    <li>
                        <a href="{{ route('tenant.properties.index') }}" wire:navigate
                           class="group flex items-center gap-x-3.5 py-2.5 px-3 text-sm rounded-lg transition-colors
                                  {{ request()->routeIs('tenant.properties.*') ? 'bg-blue-50 dark:bg-blue-500/20 text-blue-700 dark:text-blue-300' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 hover:text-gray-900 dark:hover:text-white' }}">
                    ...
                    <li>
                        <a href="{{ route('tenant.property-types.index') }}" wire:navigate
                           class="group flex items-center gap-x-3.5 py-2.5 px-3 text-sm rounded-lg transition-colors
                                  {{ request()->routeIs('tenant.property-types.*') ? 'bg-blue-50 dark:bg-blue-500/20 text-blue-700 dark:text-blue-300' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 hover:text-gray-900 dark:hover:text-white' }}">
                    ...
                    <li>
                        <a href="{{ route('tenant.services.index') }}" wire:navigate
                           class="group flex items-center gap-x-3.5 py-2.5 px-3 text-sm rounded-lg transition-colors
                                  {{ request()->routeIs('tenant.services.*') ? 'bg-blue-50 dark:bg-blue-500/20 text-blue-700 dark:text-blue-300' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 hover:text-gray-900 dark:hover:text-white' }}">
                    ...
                    <li>
                        <a href="{{ route('tenant.payments.index') }}" wire:navigate
                           class="group flex items-center gap-x-3.5 py-2.5 px-3 text-sm rounded-lg transition-colors
                                  {{ request()->routeIs('tenant.payments.*') ? 'bg-blue-50 dark:bg-blue-500/20 text-blue-700 dark:text-blue-300' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 hover:text-gray-900 dark:hover:text-white' }}">
                            <svg class="shrink-0 size-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                    ...
                    <li>
                        <a href="{{ route('tenant.employees.index') }}" wire:navigate
                           class="group flex items-center gap-x-3.5 py-2.5 px-3 text-sm rounded-lg transition-colors
                                  {{ request()->routeIs('tenant.employees.*') ? 'bg-blue-50 dark:bg-blue-500/20 text-blue-700 dark:text-blue-300' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 hover:text-gray-900 dark:hover:text-white' }}">
                    ...
                    <li>
                        <a href="{{ route('tenant.roles.index') }}" wire:navigate
                           class="group flex items-center gap-x-3.5 py-2.5 px-3 text-sm rounded-lg transition-colors
                                  {{ request()->routeIs('tenant.roles.*') ? 'bg-blue-50 dark:bg-blue-500/20 text-blue-700 dark:text-blue-300' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 hover:text-gray-900 dark:hover:text-white' }}">
                    ...
                    <li>
                        <a href="{{ route('tenant.settings.index') }}" wire:navigate
                           class="group flex items-center gap-x-3.5 py-2.5 px-3 text-sm rounded-lg transition-colors
                                  {{ request()->routeIs('tenant.settings.*') ? 'bg-blue-50 dark:bg-blue-500/20 text-blue-700 dark:text-blue-300' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 hover:text-gray-900 dark:hover:text-white' }}">
