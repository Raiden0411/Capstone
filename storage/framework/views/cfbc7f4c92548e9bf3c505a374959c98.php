...
<footer class="bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-700 font-sans pt-12 pb-6 px-4 sm:px-6 lg:px-16 w-full">
    <div class="mx-auto max-w-[90rem]">
        ...
        <div class="flex flex-col items-start justify-between gap-6 mb-10 md:flex-row md:items-end">
            <div>
                <a href="<?php echo e(route('home')); ?>" wire:navigate class="flex items-center gap-4 mb-3">
        ...
        <div class="grid grid-cols-1 gap-10 mb-14 sm:grid-cols-2 lg:grid-cols-4 lg:gap-8">
            ...
            <div>
                ...
                <ul class="space-y-3 text-sm text-gray-600 dark:text-gray-300">
                    <li><a href="<?php echo e(route('explore.map')); ?>" wire:navigate class="transition-colors hover:text-primary-600 dark:hover:text-blue-400 focus-visible:ring-2 focus-visible:ring-primary-600/50 rounded">Tourist Spots & Landmarks</a></li>
                    <li><a href="<?php echo e(route('explore.map')); ?>" wire:navigate class="transition-colors hover:text-primary-600 dark:hover:text-blue-400 focus-visible:ring-2 focus-visible:ring-primary-600/50 rounded">Dining & Local Cuisine</a></li>
                    <li><a href="<?php echo e(route('about')); ?>" wire:navigate class="transition-colors hover:text-primary-600 dark:hover:text-blue-400 focus-visible:ring-2 focus-visible:ring-primary-600/50 rounded">Heritage & Architecture</a></li>
                    <li><a href="<?php echo e(route('learnmore')); ?>" wire:navigate class="transition-colors hover:text-primary-600 dark:hover:text-blue-400 focus-visible:ring-2 focus-visible:ring-primary-600/50 rounded">Local Markets & Shops</a></li>
                    <li><a href="<?php echo e(route('explore.map')); ?>" wire:navigate class="transition-colors hover:text-primary-600 dark:hover:text-blue-400 focus-visible:ring-2 focus-visible:ring-primary-600/50 rounded">Nature & Escapes</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-3 text-sm text-gray-600 dark:text-gray-300">
                    ...
                    <li><a href="<?php echo e(route('events')); ?>" wire:navigate class="transition-colors hover:text-primary-600 dark:hover:text-blue-400 focus-visible:ring-2 focus-visible:ring-primary-600/50 rounded">Festivals & Events Calendar</a></li>
                    <li><a href="<?php echo e(route('register_business')); ?>" wire:navigate class="transition-colors hover:text-primary-600 dark:hover:text-blue-400 focus-visible:ring-2 focus-visible:ring-primary-600/50 rounded">Submit a Place</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-3 text-sm text-gray-600 dark:text-gray-300">
                    <li><a href="<?php echo e(route('about')); ?>" wire:navigate class="transition-colors hover:text-primary-600 dark:hover:text-blue-400 focus-visible:ring-2 focus-visible:ring-primary-600/50 rounded">The Victorias Story</a></li>
        ...
        <div class="flex flex-col items-center justify-between gap-6 md:flex-row text-sm text-gray-500 dark:text-gray-400">
            ...
            <div class="flex items-center gap-3">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = [
                    ...
                    <a href="#" aria-label="<?php echo e(ucfirst($name)); ?>"
