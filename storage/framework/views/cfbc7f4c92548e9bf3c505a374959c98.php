    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-10">
            ...
            <div class="col-span-1 sm:col-span-2 lg:col-span-1">
                <a href="<?php echo e(route('home')); ?>" wire:navigate class="flex items-center gap-2 mb-4">
            ...
            <div>
                ...
                <ul class="space-y-3 text-sm">
                    <li><a href="<?php echo e(route('home')); ?>" wire:navigate class="text-white/50 hover:text-brand-400 transition-colors">Home</a></li>
                    <li><a href="<?php echo e(route('about')); ?>" wire:navigate class="text-white/50 hover:text-brand-400 transition-colors">About Victorias</a></li>
                    <li><a href="<?php echo e(route('explore.map')); ?>" wire:navigate class="text-white/50 hover:text-brand-400 transition-colors">Explore Map</a></li>
                    <li><a href="<?php echo e(route('learnmore')); ?>" wire:navigate class="text-white/50 hover:text-brand-400 transition-colors">Places to Visit</a></li>
                </ul>
            </div>
        ...
        <div class="pt-6 mt-6 border-t border-white/10 flex flex-col sm:flex-row justify-between items-center gap-4">
            <p class="text-xs text-white/30">
                &copy; <?php echo e(date('Y')); ?> Victorias City Tourism. Negros Occidental, Philippines.
            </p>
