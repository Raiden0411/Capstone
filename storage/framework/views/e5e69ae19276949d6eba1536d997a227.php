                    ...
                    <div>
                        ...
                        <div class="flex items-center gap-4">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($logo): ?>
                                <img src="<?php echo e($logo->temporaryUrl()); ?>" class="h-16 w-16 object-cover rounded-lg border border-gray-200 dark:border-gray-700">
                            <?php elseif($tenant->logo): ?>
                                <img src="<?php echo e(asset('storage/'. $tenant->logo)); ?>" class="h-16 w-16 object-cover rounded-lg border border-gray-200 dark:border-gray-700">
                            <?php else: ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div>
                            ...
                            <input type="text" wire:model="slug"
                                   ...
                                   readonly>
                            <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Your public page: /business/<?php echo e($slug); ?></p>
                        </div>
                    </div>
