...
<div class="p-6 sm:p-10 max-w-7xl mx-auto space-y-6">
    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <a href="<?php echo e(route('superadmin.tenants.create')); ?>" wire:navigate class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2.5 px-5 rounded-xl shadow transition-colors flex items-center gap-2">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session()->has('message')): ?>
        <div class="bg-green-50 border-l-4 border-green-500 p-4 rounded-md shadow-sm">
            <p class="text-sm text-green-700 font-medium"><?php echo e(session('message')); ?></p>
        </div>
                ...
                <tbody class="divide-y divide-slate-200">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $this->tenants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tenant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <tr class="hover:bg-slate-50 transition-colors">
                            <td class="px-6 py-4">
                                <div class="font-bold text-slate-900"><?php echo e($tenant->name); ?></div>
                                <div class="mt-1 flex items-center gap-2">
                                    ...
                                    <span class="text-xs text-slate-400">ID: <?php echo e($tenant->id); ?></span>
                                </div>
                            </td>
                            <td class="px-6 py-4">
                                <div class="text-slate-800 font-medium"><?php echo e($tenant->email); ?></div>
                                <div class="text-xs text-slate-500 mt-0.5"><?php echo e($tenant->contact_number ?? 'No contact number'); ?></div>
                            </td>
                            <td class="px-6 py-4">
                                <span class="truncate max-w-[200px] block text-slate-600" title="<?php echo e($tenant->address); ?>">
                            ...
                            <td class="px-6 py-4 text-right space-x-2 font-medium">
                                ...
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                <a href="<?php echo e(route('superadmin.tenants.edit', $tenant->id)); ?>" wire:navigate class="text-blue-600 hover:text-blue-800 transition-colors">Edit</a>
                                <button wire:click="deleteTenant(<?php echo e($tenant->id); ?>)" wire:confirm="Are you sure you want to delete this business? This will also remove all their properties and bookings." class="text-red-600 hover:text-red-800 transition-colors">Delete</button>
                            </td>
                        </tr>
