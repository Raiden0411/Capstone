...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($tenant_id): ?>
                            <div class="space-y-2">
                                <label class="block text-sm font-medium text-gray-700 dark:text-white/70">Markers</label>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $coordinates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $coord): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                    <div class="flex items-start gap-2 border border-gray-200 dark:border-white/10 rounded-lg p-2">
                                        <div class="flex-1 grid grid-cols-2 gap-1">
                                            <div>
                                                <input type="text" wire:model="coordinates.<?php echo e($index); ?>.lat" placeholder="Lat"
                                            ...
                                            <div>
                                                <input type="text" wire:model="coordinates.<?php echo e($index); ?>.lng" placeholder="Lng"
                                                       class="w-full rounded-md bg-white dark:bg-white/10 border border-gray-300 dark:border-white/10 py-1 px-2 text-xs text-gray-900 dark:text-white">
                                            </div>
                                            <div class="col-span-2">
                                                <input type="text" wire:model="coordinates.<?php echo e($index); ?>.name" placeholder="Name (optional)"
                                                       class="w-full rounded-md bg-white dark:bg-white/10 border border-gray-300 dark:border-white/10 py-1 px-2 text-xs text-gray-900 dark:text-white">
                                            </div>
                                            <div class="col-span-2">
                                                <select wire:model="coordinates.<?php echo e($index); ?>.type"
                                                        class="w-full rounded-md bg-white dark:bg-white/10 border border-gray-300 dark:border-white/10 py-1 px-2 text-xs text-gray-900 dark:text-white">
                                        ...
                                        <button type="button" wire:click="removeCoordinate(<?php echo e($index); ?>)"
                            ...
                            <div class="p-3 border border-gray-200 dark:border-white/10 rounded-xl hover:border-brand-400/50 dark:hover:border-brand-400/50 transition-colors <?php echo e($tenant_id == $tenant->id ? 'border-brand-500/50 bg-brand-50 dark:bg-brand-500/10' : ''); ?>">
                                <div class="flex justify-between items-start">
                                    <div>
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($tenant->coordinates): ?>
                                            <span class="text-[10px] font-medium text-green-600 dark:text-green-400 flex items-center mt-1">
                                                <div class="w-1.5 h-1.5 rounded-full bg-green-500 mr-1"></div> <?php echo e(count($tenant->coordinates)); ?> marker(s)
                                            </span>
                                        <?php else: ?>
                                    ...
                                    <div class="flex flex-col gap-1">
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($tenant->coordinates): ?>
                                            <button wire:click="removeLocation(<?php echo e($tenant->id); ?>)" wire:confirm="Remove all pins for this tenant?"
