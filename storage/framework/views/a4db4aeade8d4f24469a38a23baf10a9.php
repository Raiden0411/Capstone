                        ...
                        <div class="relative group cursor-pointer rounded-2xl border-2 transition-all duration-200 overflow-hidden
                            ...
                            <div class="p-4">
                                ...
                                <p class="mt-1 text-sm text-white/60">
                                    ₱<?php echo e(number_format($property->price, 2)); ?> / day
                                </p>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <select wire:model.live="payment_method"
                            class="w-full bg-slate-800 border border-white/10 rounded-xl py-3 px-4 text-sm text-white focus:outline-none focus:ring-2 focus:ring-brand-500/50 focus:border-brand-500 transition appearance-none">
