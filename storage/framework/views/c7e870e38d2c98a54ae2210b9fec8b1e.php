...
<div
    x-data
    x-map-route-list="{
        routeId: '<?php echo e($routeId); ?>',
        mapId: '<?php echo e($mapId); ?>',
        showDistance: <?php echo e($showDistance ? 'true' : 'false'); ?>,
        showDuration: <?php echo e($showDuration ? 'true' : 'false'); ?>,
        showFastestBadge: <?php echo e($showFastestBadge ? 'true' : 'false'); ?>,
        showTimeDiff: <?php echo e($showTimeDiff ? 'true' : 'false'); ?>,
        title: '<?php echo e($title); ?>'
    }"
    style="display: none;"
    <?php echo e($attributes->merge(['class' => "absolute {$positionClasses} z-51"])); ?>>
    <div class="<?php echo e($width); ?> bg-white dark:bg-zinc-800 rounded-lg shadow-lg border border-zinc-200 dark:border-zinc-700 overflow-hidden <?php echo e($containerClass); ?>">
        <div class="px-3 py-2 border-b border-zinc-200 dark:border-zinc-700 <?php echo e($headerClass); ?>">
        ...
        <div class="divide-y divide-zinc-100 dark:divide-zinc-700">
            <template x-for="(route, index) in _rl.routes" :key="index">
                <button
                    ...
                    class="w-full px-3 py-2.5 text-left transition-colors cursor-pointer <?php echo e($itemClass); ?>">
...
<?php /**PATH C:\laragon\www\Capstone\vendor\kwasii\livewire-mapcn\resources\views/components/route-list.blade.php ENDPATH**/ ?>