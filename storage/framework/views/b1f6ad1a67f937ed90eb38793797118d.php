        ...
        <div class="w-full max-w-4xl bg-white border border-gray-200 rounded-2xl shadow-sm overflow-hidden flex dark:bg-neutral-800 dark:border-neutral-700">
            ...
            <div class="w-full lg:max-w-md p-8 sm:p-10 relative">
                ...
                <div class="flex items-center gap-x-3 mb-7">
                    ...
                    <span class="text-base font-semibold text-gray-800 dark:text-neutral-200"><?php echo e(config('app.name', 'Capstone')); ?></span>
                </div>
...
$message = $__bag->first($__errorArgs[0]); ?> <p class="mt-2 text-xs text-red-600 dark:text-red-500"><?php echo e($message); ?></p> <?php unset($message);
