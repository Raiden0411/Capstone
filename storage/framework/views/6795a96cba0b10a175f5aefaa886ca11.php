    ...
    <div class="p-6 sm:p-10 max-w-7xl mx-auto">
        <div class="mb-6 flex justify-between items-center">
            <div>
                ...
                <p class="text-slate-500">Update business details for <?php echo e($name); ?></p>
            </div>
            <a href="<?php echo e(route('superadmin.tenants.index')); ?>" wire:navigate class="text-slate-500 hover:text-slate-700 font-medium">
