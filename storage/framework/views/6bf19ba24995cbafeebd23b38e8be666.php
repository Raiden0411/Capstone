        ...
        <aside class="h-full w-[360px] flex flex-col shadow-2xl
                ...
                <div class="flex items-start justify-between mb-3">
                    ...
                    <div class="flex flex-col items-end gap-1">
                        <div class="flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-emerald-500/10 border border-emerald-500/20">
                            <span class="text-[11px] font-bold text-emerald-400 tabular-nums"><?php echo e($this->tenants->count()); ?></span>
                        ...
                        <div class="flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-white/[.04] border border-white/[.07]">
                            <span class="text-[10px] font-semibold text-zinc-500 uppercase tracking-wider"><?php echo e($this->categories->count()); ?> categories</span>
                        </div>
                    </div>
                </div>
                <div class="flex items-center gap-3 text-[11px]">
                    <a href="<?php echo e(route('home')); ?>" wire:navigate class="flex items-center gap-1 text-zinc-600 hover:text-white transition font-medium">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
                        ...
                        <a href="<?php echo e(route('my-bookings')); ?>" wire:navigate class="flex items-center gap-1 text-emerald-500/80 hover:text-emerald-400 transition font-medium">
            ...
            <div class="px-4 py-3.5 border-b border-white/[0.055] space-y-2.5">
                ...
                <div class="flex gap-1.5 overflow-x-auto pb-0.5 scrollbar-none" style="-ms-overflow-style:none;scrollbar-width:none;">
                    <button wire:click="$set('categoryFilter','')"
                            class="shrink-0 px-3 py-1.5 rounded-full text-[10.5px] font-bold uppercase tracking-[.07em] transition-all border <?php echo e($categoryFilter === '' ? 'bg-emerald-500 border-emerald-500 text-white shadow-lg shadow-emerald-500/25' : 'border-white/[.08] text-zinc-600 hover:border-white/20 hover:text-zinc-300'); ?>">All</button>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $this->categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <button wire:click="$set('categoryFilter','<?php echo e($cat); ?>')"
                                class="shrink-0 px-3 py-1.5 rounded-full text-[10.5px] font-bold uppercase tracking-[.07em] transition-all border whitespace-nowrap <?php echo e($categoryFilter === $cat ? 'bg-emerald-500 border-emerald-500 text-white shadow-lg shadow-emerald-500/25' : 'border-white/[.08] text-zinc-600 hover:border-white/20 hover:text-zinc-300'); ?>"><?php echo e($cat); ?></button>
                ...
                <div class="flex gap-1.5 bg-white/[.025] rounded-xl p-1 border border-white/[.06]">
                    <button wire:click="$set('sortBy','name')"
                            class="flex-1 py-1.5 rounded-lg text-[10.5px] font-bold uppercase tracking-[.07em] transition-all <?php echo e($sortBy === 'name' ? 'bg-white/[.08] text-white shadow-sm' : 'text-zinc-600 hover:text-zinc-400'); ?>">A – Z</button>
                    <button wire:click="$set('sortBy','distance')" @click="window.__mapCtrl?.enableDistanceSort()"
                            class="flex-1 py-1.5 rounded-lg text-[10.5px] font-bold uppercase tracking-[.07em] transition-all <?php echo e($sortBy === 'distance' ? 'bg-white/[.08] text-white shadow-sm' : 'text-zinc-600 hover:text-zinc-400'); ?>">Near Me</button>
                </div>
            </div>
            ...
            <div class="flex-1 overflow-y-auto sb-scroll py-2">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $this->tenants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $tenant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    ...
                    <div <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::$currentLoop['key'] = 'dest-'.e($tenant->id).''; ?>wire:key="dest-<?php echo e($tenant->id); ?>" wire:click="flyToTenant(<?php echo e($tenant->id); ?>)"
                         class="dest-row group cursor-pointer mx-2.5 my-0.5 px-3 py-2.5 rounded-[14px] flex items-center gap-3 transition-all duration-150 border <?php echo e($highlightedId === $tenant->id ? 'dest-active border-emerald-500/25' : 'border-transparent hover:bg-white/[.028] hover:border-white/[.06]'); ?>"
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($tenant->logo): ?>
                            <img src="<?php echo e(asset('storage/'.$tenant->logo)); ?>" alt="<?php echo e($tenant->name); ?>" class="w-11 h-11 rounded-xl object-cover border border-white/10 flex-shrink-0">
                        <?php else: ?>
                            <div class="w-11 h-11 rounded-xl flex items-center justify-center text-[13px] font-black flex-shrink-0 text-white select-none"
                                 style="background: linear-gradient(135deg, hsl(<?php echo e($hue); ?>,55%,38%) 0%, hsl(<?php echo e($hue); ?>,60%,52%) 100%); box-shadow:0 4px 14px hsl(<?php echo e($hue); ?>,55%,38%,.4);">
                                <?php echo e(strtoupper(substr($tenant->name, 0, 2))); ?>

                            </div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <div class="flex-1 min-w-0">
                            <p class="text-[13px] font-semibold text-white truncate leading-snug"><?php echo e($tenant->name); ?></p>
                            <p class="text-[10.5px] text-zinc-600 mt-0.5 font-medium"><?php echo e($tenant->typeOfTenant?->type ?? 'Business'); ?></p>
                            <span class="xdist-badge hidden text-[10px] font-bold mt-0.5 inline-block"
                                  data-lat="<?php echo e($tenant->coordinates[0]['lat'] ?? ''); ?>"
                                  data-lng="<?php echo e($tenant->coordinates[0]['lng'] ?? ''); ?>"
                                  style="color: hsl(<?php echo e($hue); ?>,65%,60%)"></span>
                        </div>
                        <button onclick="event.stopPropagation(); window.__mapCtrl?.getDirections(<?php echo e($index); ?>, 0)"
            ...
            <div class="px-4 py-2.5 border-t border-white/[.055] flex justify-between items-center">
                <span class="text-[11px] text-zinc-700 font-medium"><?php echo e($this->tenants->count()); ?> <?php echo e(Str::plural('place', $this->tenants->count())); ?></span>
        ...
        <div class="absolute top-4 right-4 z-[800] flex gap-1.5">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = ['dark' => ['🌑','Dark'], 'light' => ['🗺️','Light'], 'satellite' => ['🛰️','Satellite']]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s => $meta): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                <button @click="setStyle('<?php echo e($s); ?>')"
                        :class="mapStyle === '<?php echo e($s); ?>' ? 'bg-emerald-500 border-emerald-400 text-white shadow-emerald-500/30 shadow-lg scale-105' : 'bg-[rgba(8,12,22,0.90)] border-white/[.09] text-zinc-500 hover:bg-white/[.06] hover:text-white'"
                        class="w-9 h-9 rounded-xl border backdrop-blur-xl text-[15px] flex items-center justify-center transition-all duration-200 shadow-lg" title="<?php echo e($meta[1]); ?>"><?php echo e($meta[0]); ?></button>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
        </div>
...
<?php $__env->stopPush(); ?><?php /**PATH C:\laragon\www\Capstone\storage\framework/views/livewire/views/edb49f3a.blade.php ENDPATH**/ ?>