    ...
    <section class="py-20 bg-[#1B261D]">
        <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col md:flex-row md:justify-between md:items-end mb-10 gap-8">
                ...
                <a href="<?php echo e(route('explore.map')); ?>" wire:navigate class="py-3 px-7 inline-flex items-center gap-x-2 text-sm font-semibold rounded-full bg-[#C9A84C] text-[#1B261D] hover:bg-[#b8963e] transition-colors duration-200 focus:outline-none">
                    View Map
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $this->tenants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tenant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <div class="group flex flex-col bg-white rounded-3xl overflow-hidden shadow-md hover:shadow-2xl transition-all duration-500 hover:-translate-y-1.5">
                        <div class="relative h-56 overflow-hidden">
                            <img src="<?php echo e($tenant->logo ? Storage::url($tenant->logo) : 'https://images.unsplash.com/photo-1470071459604-3b5ec3a7fe05?q=80&w=800'); ?>"
                        ...
                        <div class="flex flex-col flex-1 p-6 bg-white">
                            <h3 class="text-lg font-extrabold text-[#1B261D] leading-snug mb-2"><?php echo e($tenant->name); ?></h3>
                            <p class="text-sm text-[#4A554E] leading-relaxed mb-6 flex-1">
                                <?php echo e(Str::limit($tenant->address, 100)); ?>

                            </p>
                            <div class="flex justify-between items-center gap-2 pt-4 border-t border-[#f0efe8]">
                                <span class="text-[11px] text-[#7E8A74] font-semibold"><?php echo e($tenant->contact_number); ?></span>
                                <a href="<?php echo e(route('tenant.show', $tenant->slug)); ?>" wire:navigate class="shrink-0 py-2 px-5 text-xs font-bold rounded-full border-2 border-[#C9A84C] text-[#C9A84C] hover:bg-[#C9A84C] hover:text-[#1B261D] transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-[#C9A84C]/30">
                                    Explore
                                </a>
                            </div>
                        </div>
                ...
                <div class="lg:col-span-2 pt-2 order-1 lg:order-2">
                    ...
                    <div id="location-list" class="flex flex-col gap-2 mb-8">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $this->mapLocations(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $loc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <button onclick="focusLocation(<?php echo e($index); ?>)" class="group flex items-center gap-3 bg-white/5 hover:bg-white/10 border border-white/8 rounded-xl px-4 py-3 cursor-pointer transition-all duration-200 text-left w-full focus:outline-none focus:ring-1 focus:ring-opacity-50">
                                ...
                                <span class="text-[11px] text-white/35 font-medium shrink-0"><?php echo e($loc['type']); ?></span>
                            </button>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                    </div>
