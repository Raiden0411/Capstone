...
<header
    ...
    class="sticky top-0 inset-x-0 flex flex-wrap md:justify-start md:flex-nowrap z-30 w-full bg-[#f2f3f5] dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700 text-sm py-2.5 transition-all duration-300"
>
  <nav class="px-4 sm:px-6 flex basis-full items-center w-full mx-auto justify-between gap-2">
    ...
    <div class="flex items-center gap-2 lg:hidden">
      <button type="button"
              class="size-8 flex justify-center items-center gap-x-2 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors"
    ...
    <div class="hidden md:flex flex-1 items-center gap-2 px-2">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($tenant): ?>
            <span class="text-xs text-gray-500 dark:text-gray-400 font-mono"><?php echo e($tenant->name); ?></span>
    ...
    <div class="flex items-center gap-2 ms-auto">
      ...
      <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($tenant): ?>
        <a href="<?php echo e(route('tenant.show', $tenant->slug)); ?>" target="_blank" rel="noopener"
           class="hidden sm:inline-flex items-center gap-2 py-2 px-3 rounded-lg text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors text-xs font-medium">
      ...
      <button type="button"
              @click="toggleDark()"
              class="flex justify-center items-center size-9 rounded-lg text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none transition-colors"
      ...
      <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
        ...
        <div class="relative"
          ...
          <button type="button"
                  @click="open = !open"
                  class="flex items-center gap-2 py-1.5 px-2 rounded-lg text-gray-600 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors focus:outline-none"
                  aria-expanded="open"
                  aria-haspopup="true">
            ...
            <?php else: ?>
              <div class="w-6 h-6 rounded-full bg-[#376df1] text-white flex items-center justify-center font-bold text-xs shrink-0">
          ...
          <div x-cloak
            ...
            <div class="px-4 py-3 border-b border-gray-200 dark:border-gray-700">
              <div class="flex items-center gap-3">
                ...
                <?php else: ?>
                  <div class="w-10 h-10 rounded-full bg-[#376df1] text-white flex items-center justify-center font-bold text-sm shrink-0">
                    <?php echo e(strtoupper(substr(auth()->user()->name ?? 'U', 0, 1))); ?>
            ...
            <div class="p-1.5 space-y-0.5">
              <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($tenant): ?>
                <a href="<?php echo e(route('tenant.settings.index')); ?>" wire:navigate
                   class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700 hover:text-gray-900 dark:hover:text-white transition-colors"
                   @click="open = false">
      ...
      <?php else: ?>
        <a href="<?php echo e(route('login')); ?>" class="py-2 px-4 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg bg-[#376df1] text-white hover:bg-blue-700 transition-colors">Sign in</a>
      <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    </div>
  </nav>
