...
<div class="p-4 sm:p-6 lg:p-10 max-w-7xl mx-auto text-gray-900 dark:text-white space-y-8">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            ...
            <p class="text-gray-500 dark:text-slate-400 mt-1">Welcome back, <?php echo e(Auth::user()->tenant->name ?? 'Admin'); ?>.</p>
        </div>
        <div class="flex gap-2">
            <a href="<?php echo e(route('tenant.bookings.create')); ?>" wire:navigate class="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white font-medium py-2.5 px-5 rounded-xl shadow-sm transition-colors">
                New Booking
            </a>
            <a href="<?php echo e(route('tenant.properties.index')); ?>" wire:navigate class="inline-flex items-center gap-2 bg-white dark:bg-slate-800 border border-gray-300 dark:border-slate-600 hover:bg-gray-50 dark:hover:bg-slate-700 text-gray-700 dark:text-slate-300 font-medium py-2.5 px-5 rounded-xl shadow-sm transition-colors">
                Properties
            </a>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div class="rounded-2xl bg-white dark:bg-[#0b0f19] border border-gray-200 dark:border-slate-700/50 p-6 shadow-sm">
            ...
            <p class="text-3xl font-bold text-gray-900 dark:text-white"><?php echo e(number_format($this->stats['total_bookings'])); ?></p>
            <div class="flex gap-3 mt-2">
                <span class="text-xs text-amber-600 dark:text-amber-400"><?php echo e($this->stats['pending_bookings']); ?> pending</span>
                <span class="text-xs text-green-600 dark:text-green-400"><?php echo e($this->stats['confirmed_bookings']); ?> confirmed</span>
                <span class="text-xs text-blue-600 dark:text-blue-400"><?php echo e($this->stats['completed_bookings']); ?> completed</span>
            </div>
        </div>
        ...
        <div class="rounded-2xl bg-white dark:bg-[#0b0f19] border border-gray-200 dark:border-slate-700/50 p-6 shadow-sm">
            ...
            <p class="text-3xl font-bold text-gray-900 dark:text-white">₱<?php echo e(number_format($this->stats['revenue_this_month'], 2)); ?></p>
            <div class="flex items-center gap-2 mt-2">
                <span class="text-xs font-medium <?php echo e($this->revenueTrend >= 0 ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'); ?> flex items-center gap-0.5">
        ...
        <div class="rounded-2xl bg-white dark:bg-[#0b0f19] border border-gray-200 dark:border-slate-700/50 p-6 shadow-sm">
            ...
            <p class="text-3xl font-bold text-gray-900 dark:text-white"><?php echo e($this->stats['arrivals_today']); ?> / <?php echo e($this->stats['departures_today']); ?></p>
            <p class="text-xs text-gray-500 dark:text-slate-400 mt-2">Arrivals / Departures</p>
            <p class="text-sm text-gray-600 dark:text-slate-300 mt-1"><?php echo e($this->stats['occupied_properties']); ?> properties occupied</p>
        </div>
        ...
        <div class="rounded-2xl bg-white dark:bg-[#0b0f19] border border-gray-200 dark:border-slate-700/50 p-6 shadow-sm">
            ...
            <p class="text-3xl font-bold text-gray-900 dark:text-white"><?php echo e(number_format($this->stats['total_customers'])); ?></p>
    ...
    <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
        <div class="rounded-xl bg-white dark:bg-[#0b0f19] border border-gray-200 dark:border-slate-700/50 shadow-sm p-4 flex items-center gap-3">
            ...
            <div>
                ...
                <p class="text-xl font-bold text-gray-900 dark:text-white"><?php echo e($this->stats['total_properties']); ?></p>
            </div>
        </div>
        <div class="rounded-xl bg-white dark:bg-[#0b0f19] border border-gray-200 dark:border-slate-700/50 shadow-sm p-4 flex items-center gap-3">
            ...
            <div>
                ...
                <p class="text-xl font-bold text-gray-900 dark:text-white"><?php echo e($this->stats['total_services']); ?></p>
            </div>
        </div>
        <div class="rounded-xl bg-white dark:bg-[#0b0f19] border border-gray-200 dark:border-slate-700/50 shadow-sm p-4 flex items-center gap-3">
            ...
            <div>
                ...
                <p class="text-xl font-bold text-gray-900 dark:text-white"><?php echo e($this->stats['total_employees']); ?></p>
            </div>
        </div>
        <div class="rounded-xl bg-white dark:bg-[#0b0f19] border border-gray-200 dark:border-slate-700/50 shadow-sm p-4 flex items-center gap-3">
            ...
            <div>
                ...
                <p class="text-xl font-bold text-gray-900 dark:text-white"><?php echo e(Payment::where('payment_status', '!=', 'paid')->count()); ?></p>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2 bg-white dark:bg-[#0b0f19] rounded-xl border border-gray-200 dark:border-slate-700/50 shadow-sm overflow-hidden">
            <div class="px-6 py-5 border-b border-gray-200 dark:border-slate-700/50 bg-gray-50 dark:bg-slate-800/50 flex justify-between items-center">
                ...
                <a href="<?php echo e(route('tenant.bookings.index')); ?>" wire:navigate class="text-sm text-blue-600 dark:text-blue-400 hover:underline font-medium">View All &rarr;</a>
            </div>
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200 dark:divide-slate-700/30">
                    ...
                    <tbody class="divide-y divide-gray-200 dark:divide-slate-700/30 text-gray-700 dark:text-slate-300">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $this->recentBookings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $booking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <tr class="hover:bg-gray-50 dark:hover:bg-slate-800/50 transition-colors">
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-mono"><?php echo e($booking->booking_reference); ?></td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm"><?php echo e($booking->customer->name ?? 'N/A'); ?></td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm"><?php echo e($booking->check_in->format('M d, Y')); ?></td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900 dark:text-white">₱<?php echo e(number_format($booking->total_amount, 2)); ?></td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    <?php else: ?>
                                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-gray-100 dark:bg-slate-500/20 text-gray-600 dark:text-slate-400"><?php echo e(ucfirst($booking->status)); ?></span>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                </td>
                            </tr>
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white dark:bg-[#0b0f19] rounded-xl border border-gray-200 dark:border-slate-700/50 shadow-sm overflow-hidden">
                ...
                <div class="divide-y divide-gray-200 dark:divide-slate-700/30">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $this->upcomingArrivals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $booking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <div class="px-6 py-4 hover:bg-gray-50 dark:hover:bg-slate-800/50">
                            <p class="text-sm font-medium text-gray-900 dark:text-white"><?php echo e($booking->customer->name ?? 'Guest'); ?></p>
                            <p class="text-xs text-gray-500 dark:text-slate-400"><?php echo e($booking->check_in->format('M d, Y')); ?> · <?php echo e($booking->booking_reference); ?></p>
                        </div>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
            ...
            <div class="bg-white dark:bg-[#0b0f19] rounded-xl border border-gray-200 dark:border-slate-700/50 shadow-sm overflow-hidden">
                ...
                <div class="divide-y divide-gray-200 dark:divide-slate-700/30">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $this->recentPayments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <div class="px-6 py-4 hover:bg-gray-50 dark:hover:bg-slate-800/50">
                            <div class="flex justify-between">
                                <span class="text-sm font-medium text-gray-900 dark:text-white">₱<?php echo e(number_format($payment->amount, 2)); ?></span>
                                <span class="text-xs text-gray-500 dark:text-slate-400"><?php echo e($payment->paid_at?->format('M d') ?? '—'); ?></span>
                            </div>
                            <p class="text-xs text-gray-500 dark:text-slate-400">Ref: <?php echo e($payment->reference_number ?? '—'); ?></p>
                        </div>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
            ...
            <div class="bg-white dark:bg-[#0b0f19] rounded-xl border border-gray-200 dark:border-slate-700/50 shadow-sm p-5">
                ...
                <div class="grid grid-cols-2 gap-2">
                    <a href="<?php echo e(route('tenant.customers.create')); ?>" wire:navigate class="flex items-center gap-2 p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-slate-800 text-sm text-gray-700 dark:text-slate-300 transition-colors">
                    ...
                    <a href="<?php echo e(route('tenant.services.create')); ?>" wire:navigate class="flex items-center gap-2 p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-slate-800 text-sm text-gray-700 dark:text-slate-300 transition-colors">
                    ...
                    <a href="<?php echo e(route('tenant.employees.create')); ?>" wire:navigate class="flex items-center gap-2 p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-slate-800 text-sm text-gray-700 dark:text-slate-300 transition-colors">
                    ...
                    <a href="<?php echo e(route('tenant.settings.index')); ?>" wire:navigate class="flex items-center gap-2 p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-slate-800 text-sm text-gray-700 dark:text-slate-300 transition-colors">
